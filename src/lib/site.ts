export const site = {
  ...
  mapsEmbed:
    "https://maps.google.com/maps?q=Fun+Valley+Resort+Near+Baagh+Bagicha+Farms+Sector+135+Noida&z=15&output=embed",
  mapsDirections:
    "https://www.google.com/maps/dir/?api=1&destination=Fun+Valley+Resort+Near+Baagh+Bagicha+Farms+Sector+135+Noida",
} as const;
...
export const events: EventItem[] = [
  {
    ...
    kicker: "Cake, DJ, pool",
    summary:
      "A full birthday setup in Noida — décor, music, pool access, and unlimited food, managed end to end.",
  ...
  },
  {
    ...
    kicker: "Day or night",
    summary:
      "Music, lights, food, and a wide pool for friends, family, or a private group — with safety and comfort in mind.",
  ...
  },
  {
    ...
    summary:
      "A private setup for the last single days — pool, music, food, and a ground that stays yours for the night.",
  ...
  },
  {
    ...
    summary:
      "Team outings, annual days, and office parties with space to breathe — lawn, food, and a setup that isn’t a hotel ballroom.",
  ...
  },
  {
    ...
    kicker: "Lawn & lunch",
    summary:
      "Elegant seating, music, and a lively but comfortable atmosphere for ladies’ gatherings in Sector 135.",
  ...
  },
  {
    ...
    summary:
      "Themes, music, catering, and a poolside table if you want the evening to stay small — or a lawn if you don’t.",
  ...
  },
  {
    ...
    summary:
      "Haldi, mehendi, sangeet, and reception parties on the lawn — with décor, catering, and room for the baraat to breathe.",
  ...
  },
  {
    ...
    summary:
      "Stay on after the music. Night-stay bookings for families and wedding parties who don’t want the drive home at 2 a.m.",
...
export const packages = [
  {
    ...
    points: ["Dedicated seating", "Food package", "Décor starter set"],
  },
  {
    name: "Celebration",
    guests: "30 – 80 guests",
    note: "The usual party size. Pool + lawn, DJ, unlimited food.",
    points: ["Pool access option", "DJ / sound", "Full décor & lighting"],
  },
  {
    name: "Grand lawn",
    guests: "80 – 200+ guests",
    note: "Corporate days, receptions, mehendi, sangeet.",
    points: ["Full lawn", "Custom menu", "End-to-end event desk"],
  },
] as const;
